...
| PATCH  | Update specific fields      | Usually    | Yes          |
| DELETE | Remove a resource           | Yes        | No           |

The HTTP spec does not require PATCH to be idempotent — it depends on your implementation (a "set field to value" patch is idempotent; an "append to list" patch is not).
