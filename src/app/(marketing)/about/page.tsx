...
export const metadata: Metadata = buildMetadata({
  title: "About",
  description:
    "DURA is an open-source learning platform that takes anyone from their first click to engineering leadership through mastery-gated, standards-backed education.",
  path: "/about",
});
    ...
    <main className="mx-auto max-w-[720px] px-6 py-16">
      <header className="mb-12">
        ...
        <p className="mt-4 text-lg leading-relaxed text-[var(--color-text-secondary)]">
          DURA takes anyone from their first click toward engineering leadership. No shortcuts. No
