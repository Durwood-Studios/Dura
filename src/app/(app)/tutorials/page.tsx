...
const TUTORIALS = [
  ...
  },
  {
    ...
    description: "Bell badge, dropdown panel, read/unread, real-time via SSE.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "Drag-and-drop, progress bars, type validation, image preview.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Inverted index, tokenization, TF-IDF ranking, fuzzy matching.",
    difficulty: "intermediate",
    minutes: 210,
  },
  {
    ...
    description: "Typed states, transitions, guards, actions, visualization.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Content CRUD API, Markdown, media uploads, webhook notifications.",
    difficulty: "intermediate",
    minutes: 210,
  },
  {
    ...
    description: "LCS diff algorithm, side-by-side and inline views, highlighting.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Cookie-free event collection, session tracking, funnel visualization.",
    difficulty: "intermediate",
    minutes: 210,
  },
  {
    ...
    description: "Plugin registry, lifecycle hooks, dependency resolution, sandboxing.",
    difficulty: "advanced",
    minutes: 180,
  },
  {
    ...
    description: "Live pattern matching, capture groups, flags, match highlighting.",
    difficulty: "beginner",
    minutes: 120,
  },
  {
    ...
    description: "HSL manipulation, contrast checker, export as CSS/Tailwind.",
    difficulty: "beginner",
    minutes: 120,
  },
  {
    ...
    description: "Intent detection, entity extraction, conversation flow, context.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "YAML test definitions, HTTP runner, assertion engine, CI reports.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "AST parsing, formatting rules, indentation, line width control.",
    difficulty: "advanced",
    minutes: 210,
  },
  {
    ...
    description: "Shorten URLs via API, local history, cross-platform clipboard.",
    difficulty: "beginner",
    minutes: 120,
  },
  {
    ...
    description: "Parse JSON Schema, validate documents, collect errors with paths.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Boards, columns, cards, drag ordering, user assignment, PostgreSQL.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "HTTP API, headless rendering, screenshot capture, caching.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Pre-commit linting, commit validation, pre-push tests, cross-platform.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "HTML templates, variable substitution, batch generation, download API.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "JSON endpoint definitions, fake data, simulated latency, hot-reload.",
    difficulty: "beginner",
    minutes: 120,
  },
  {
    ...
    description: "Parse annotations, type environment, check assignments, report errors.",
    difficulty: "advanced",
    minutes: 240,
  },
  {
    ...
    description: "Event store, projections, snapshots, replay, CQRS read models.",
    difficulty: "advanced",
    minutes: 210,
  },
  {
    ...
    description: "Experiment definitions, random assignment, statistical significance.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "MDX content, sidebar nav, search, versioning, dark mode.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "Receive, queue, deliver webhooks with retry and signature verification.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Trie-based prefix matching, ranked suggestions, keyboard navigation.",
    difficulty: "intermediate",
    minutes: 150,
  },
  {
    ...
    description: "Model definitions, query builder, migrations, relationships.",
    difficulty: "advanced",
    minutes: 240,
  },
  {
    ...
    description: "Multi-URL monitoring, response times, failure alerts, scheduling.",
    difficulty: "beginner",
    minutes: 120,
  },
  {
    ...
    description: "Names, emails, addresses, custom schemas, seeded reproducibility.",
    difficulty: "beginner",
    minutes: 120,
  },
  {
    ...
    description: "Auth, team management, Stripe billing, dashboard, deployment.",
    difficulty: "advanced",
    minutes: 240,
  },
  {
    ...
    description: "AES-256 vault, password generation, clipboard copy, search.",
    difficulty: "advanced",
    minutes: 210,
  },
  {
    ...
    description: "React Native with Expo, drag-and-drop, AsyncStorage persistence.",
    difficulty: "intermediate",
    minutes: 210,
  },
  {
    ...
    description: "Parse git log, render commit graph, interactive zoom/pan.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "Inject latency, kill processes, corrupt responses, schedule experiments.",
    difficulty: "advanced",
    minutes: 180,
  },
  {
    ...
    description: "Grid system, utility classes, component styles, dark mode, npm package.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "Monaco editor, live preview, console output, multiple files, share.",
    difficulty: "intermediate",
    minutes: 210,
  },
  {
    ...
    description: "Products, stock tracking, low-stock alerts, barcode lookup, reports.",
    difficulty: "intermediate",
    minutes: 180,
  },
  {
    ...
    description: "Start/stop timer, project categories, reports, chart visualization.",
    difficulty: "beginner",
    minutes: 150,
  },
  {
    ...
    description: "Generate YAML manifests, deploy to cluster, health checks, rollback.",
    difficulty: "advanced",
    minutes: 210,
  },
  {
    ...
    description: "Auth, content management, progress tracking, certificates, payments.",
    difficulty: "advanced",
    minutes: 240,
  },
] as const;
