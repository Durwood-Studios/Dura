...
const LESSONS: readonly PhaseELesson[] = [
  {
    ...
    standards: ["ISO/IEC 9899:2018 (C17)"],
    languages: ["c"],
  ...
  },
  {
    ...
    standards: ["ARMv7-M Architecture Reference Manual"],
    languages: ["c"],
    hasVerifyArtifact: false,
  },
  {
  ...
  },
  {
    ...
    target: "any-cortex-m",
    standards: ["POSIX.1-2017 Real-time Extensions"],
    languages: ["c"],
    hasVerifyArtifact: false,
  },
  {
  ...
  },
  {
    ...
    estimatedMinutes: 120,
    target: "stm32f4-discovery",
    standards: ["Rust Reference (rust-lang.org)"],
    languages: ["rust"],
    hasVerifyArtifact: false,
  },
  {
