  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-8 shadow-sm backdrop-blur-xl">
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-bold text-[var(--color-text-primary)]">Sign in to DURA</h1>
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Google and Apple OAuth are not yet enabled — disabled with a "Coming soon" hint */}
        <div className="group relative">
          <button
            ...
            aria-disabled="true"
            title="Coming soon"
            className="flex w-full cursor-not-allowed items-center justify-center gap-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-primary)] px-4 py-2.5 text-sm font-medium text-[var(--color-text-muted)] opacity-60"
          >
          ...
          <span
            role="tooltip"
            className="pointer-events-none absolute -top-8 left-1/2 -translate-x-1/2 rounded-md bg-[var(--color-bg-surface-hover)] px-2 py-1 text-xs font-medium whitespace-nowrap text-[var(--color-text-primary)] opacity-0 shadow-sm transition-opacity duration-150 group-hover:opacity-100"
          >
            Coming soon
          </span>
        </div>
