    ...
    <section className="bg-white px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-[#525252]">Four pillars. No shortcuts. No fluff.</p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-5 sm:grid-cols-2">
          {FEATURES.map((feature, i) => (
            <motion.div
              ...
              className="rounded-xl border border-[#E5E5E5] bg-[#FAFAFA] p-8 transition-all duration-200 hover:border-[#10B981]/40 hover:bg-[#F0FDF4]/50"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#10B981]/10 text-[#10B981]">
                {feature.icon}
              </div>
              <h3 className="mt-5 text-xl font-semibold text-[#171717]">{feature.title}</h3>
              <p className="mt-2 text-base leading-relaxed text-[#525252]">{feature.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
